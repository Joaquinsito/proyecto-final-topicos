                    ...
                    <div className="col-md-8">
                        <div className="p-5 card">
                            <Form onSubmit={handleSubmit}>
                                <Form.Label className='form-control-lg fs-2 fw-bold col-sm-12 text-center'>Add new user</Form.Label>
                                ...
                                <Form.Group className='mt-4 text-center'>
                                    <Button className='col-sm-3 text-center' variant="primary" type="submit">
                                        Add user
                                    </Button>
                                </Form.Group>
